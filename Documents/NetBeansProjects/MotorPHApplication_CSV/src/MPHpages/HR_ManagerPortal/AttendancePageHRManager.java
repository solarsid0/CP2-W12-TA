...
public class AttendancePageHRManager extends javax.swing.JFrame {
     ...
     * @param userRole
     */
    public AttendancePageHRManager(String fullName, String employeeID, String userRole) {
        initComponents();
    ...
    private AttendancePageHRManager() {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AttendancePageHRManager.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AttendancePageHRManager().setVisible(true);
            }
        });
    }
