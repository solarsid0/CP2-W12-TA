...
public class PayInfoHRManager extends javax.swing.JFrame {
    ...
    public PayInfoHRManager(String fullName, String employeeID, String userRole) {
    ...
    public static void main(String args[]) {
       SwingUtilities.invokeLater(new Runnable() {
            public void run() {
                PayInfoHRManager frame = new PayInfoHRManager(null);
